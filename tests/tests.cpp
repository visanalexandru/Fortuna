...
TEST_CASE("Mobility","[eval]"){
    ...
    REQUIRE(middle_game==C_MOBILITY_MULTIPLIER_KNIGHT*7+C_MOBILITY_MULTIPLIER_BISHOP*5+C_MOBILITY_MULTIPLIER_ROOK*8+C_MOBILITY_MULTIPLIER_QUEEN*12);

    middle_game=0,end_game=0;
    score_mobility<C_BLACK>(board,middle_game,end_game);
    REQUIRE(middle_game==end_game);
    REQUIRE(middle_game==C_MOBILITY_MULTIPLIER_KNIGHT*8+C_MOBILITY_MULTIPLIER_BISHOP*9+C_MOBILITY_MULTIPLIER_ROOK*7+C_MOBILITY_MULTIPLIER_QUEEN*11);
